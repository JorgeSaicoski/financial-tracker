...
-- accounts(id), which already exists by this point) and transfer_id
-- (added by migration 005) both need to be carried over too, since this
-- rebuilds the *whole* table, not just the column 001 originally shipped.
