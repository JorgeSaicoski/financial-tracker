...
func TestUpdateMovementMetadataOnSyncedMovementEditsInPlace(t *testing.T) {
	...
	uc := NewUpdateMovement(repo, newFakeAccountRepo(), newFakePlanRepo(), trigger)
...
func TestUpdateMovementPostSyncCombinedAmountAndMetadataEdit(t *testing.T) {
	...
	uc := NewUpdateMovement(repo, newFakeAccountRepo(), newFakePlanRepo(), &fakeSyncTrigger{})
...
func TestUpdateMovementValidatesLikeCreate(t *testing.T) {
	...
	uc := NewUpdateMovement(repo, accounts, newFakePlanRepo(), &fakeSyncTrigger{})
