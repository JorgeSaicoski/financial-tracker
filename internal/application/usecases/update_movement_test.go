...
func TestUpdateMovementMetadataOnSyncedMovementEditsInPlace(t *testing.T) {
	...
	uc := NewUpdateMovement(repo, newFakeAccountRepo(), newFakePaymentMethodRepo(), trigger)
...
func TestUpdateMovementPostSyncCombinedAmountAndMetadataEdit(t *testing.T) {
	...
	uc := NewUpdateMovement(repo, newFakeAccountRepo(), newFakePaymentMethodRepo(), &fakeSyncTrigger{})
...
func TestUpdateMovementValidatesLikeCreate(t *testing.T) {
	...
	uc := NewUpdateMovement(repo, accounts, newFakePaymentMethodRepo(), &fakeSyncTrigger{})
