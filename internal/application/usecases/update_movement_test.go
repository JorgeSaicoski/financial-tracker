...
func TestUpdateMovementMetadataOnSyncedMovementEditsInPlace(t *testing.T) {
	...
	uc := NewUpdateMovement(repo, newFakeAccountRepo(), newFakePaymentMethodRepo(), newFakePlanRepo(), trigger)
...
func TestUpdateMovementPostSyncCombinedAmountAndMetadataEdit(t *testing.T) {
	...
	uc := NewUpdateMovement(repo, newFakeAccountRepo(), newFakePaymentMethodRepo(), newFakePlanRepo(), &fakeSyncTrigger{})
...
func TestUpdateMovementValidatesLikeCreate(t *testing.T) {
	...
	uc := NewUpdateMovement(repo, accounts, newFakePaymentMethodRepo(), newFakePlanRepo(), &fakeSyncTrigger{})
