...
func TestUpdateRecurringRuleDeactivatesWithoutTouchingOtherFields(t *testing.T) {
	...
	uc := NewUpdateRecurringRule(repo, newFakeAccountRepo(), newFakePaymentMethodRepo())
...
func TestUpdateRecurringRuleRejectsAccountCurrencyMismatch(t *testing.T) {
	...
	uc := NewUpdateRecurringRule(repo, accounts, newFakePaymentMethodRepo())
...
func TestUpdateRecurringRuleNotFound(t *testing.T) {
	uc := NewUpdateRecurringRule(newFakeRecurringRuleRepo(), newFakeAccountRepo(), newFakePaymentMethodRepo())
