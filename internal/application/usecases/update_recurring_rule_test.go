...
func TestUpdateRecurringRuleDeactivatesWithoutTouchingOtherFields(t *testing.T) {
	...
	uc := NewUpdateRecurringRule(repo, newFakeAccountRepo(), newFakePaymentMethodRepo(), newFakeCategoryRepo())
...
func TestUpdateRecurringRuleRejectsAccountCurrencyMismatch(t *testing.T) {
	...
	uc := NewUpdateRecurringRule(repo, accounts, newFakePaymentMethodRepo(), newFakeCategoryRepo())
...
func TestUpdateRecurringRuleNotFound(t *testing.T) {
	uc := NewUpdateRecurringRule(newFakeRecurringRuleRepo(), newFakeAccountRepo(), newFakePaymentMethodRepo(), newFakeCategoryRepo())
