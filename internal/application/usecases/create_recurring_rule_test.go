...
func TestCreateRecurringRuleValidatesDayOfMonth(t *testing.T) {
	uc := NewCreateRecurringRule(newFakeRecurringRuleRepo(), newFakeAccountRepo(), newFakeCategoryRepo())
...
func TestCreateRecurringRuleRejectsAccountCurrencyMismatch(t *testing.T) {
	...
	uc := NewCreateRecurringRule(newFakeRecurringRuleRepo(), accounts, newFakeCategoryRepo())
