...
func TestCreateRecurringRuleValidatesDayOfMonth(t *testing.T) {
	uc := NewCreateRecurringRule(newFakeRecurringRuleRepo(), newFakeAccountRepo(), newFakePaymentMethodRepo(), newFakeCategoryRepo())
...
func TestCreateRecurringRuleRejectsAccountCurrencyMismatch(t *testing.T) {
	...
	uc := NewCreateRecurringRule(newFakeRecurringRuleRepo(), accounts, newFakePaymentMethodRepo(), newFakeCategoryRepo())
