...
func TestGetCashflowExcludesTransfers(t *testing.T) {
	...
	if _, err := NewTransferBetweenAccounts(movements, accounts, newFakeUserSettingsRepo(), newFakeCategoryRepo()).Execute(context.Background(), TransferBetweenAccountsInput{
