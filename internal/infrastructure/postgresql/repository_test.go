...
<<<<<<< HEAD
	if _, err := db.Exec(`TRUNCATE TABLE account_snapshots, movements, credit_card_purchases, accounts, recurring_rules, user_local_archive_settings, user_settings, categories, user_data_keys, user_ledger_pseudonyms, subscriptions CASCADE`); err != nil {
=======
