...
func openTestDB(t *testing.T) *sql.DB {
	...
	if _, err := db.Exec(`TRUNCATE TABLE account_snapshots, movements, credit_card_purchases, accounts, user_local_archive_settings, user_settings, plans CASCADE`); err != nil {
